...
You can visit http://3.88.53.52.xip.io or http://ec2-3-88-53-52.compute-1.amazonaws.com for the website deployed.
...
### Step 1: Start a new Ubuntu Linux server instance on Amazon EC2 
  ...
  - we can download a .pem file and connect with following command
    ```
    ssh -i 20_FEB_2019_10AM_CATALOG.pem ubuntu@3.88.53.52
    ``` 
...
- To check port 2200 wether working or not by `ssh -i 20_FEB_2019_10AM_CATALOG.pem -p 2200 ubuntu@3.88.53.52` 
...
### Step 7: Create an SSH key pair for `grader`
  ...
  - Restart SSH: `sudo service ssh restart`
  - On the local machine, cheking if the grader account working or not by running this command : `ssh -i 20_FEB_2019_10AM_CATALOG.pem -p 2200 grader@3.88.53.52`.
...
`sudo git clone https://github.com/siddartha19/catalog.git`.
...
http://ec2-3-88-53-52.compute-1.amazonaws.com as authorized JavaScript 
origins.
- Add http://3.88.53.52.xip.io/login,
      http://3.88.53.52.xip.io/gconnect,
      http://3.88.53.52.xip.io/callback
...
### Step 13.2: Set up and enable a virtual host
  ...
  ```
  <VirtualHost *:80>
      ServerName 3.88.53.52.xip.io
      ServerAlias ec2-3-88-53-52.compute-1.amazonaws.com
      ServerAdmin ubuntu@3.88.53.52
...
- Open your browser to http://3.88.53.52.xip.io
